...
function Reference() {
  ...
  return (
    <section className="py-20 bg-[#d8e9f0]" id="references">
        ...
        >
          {references.map((reference, index) => (
            <motion.div
              ...
              className="bg-[#d8e9f0] rounded-xl shadow-lg p-6 hover:border-red-500 border-2 border-[#fff] transition-all duration-300"
            >
