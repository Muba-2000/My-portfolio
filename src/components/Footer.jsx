...
function Footer() {
  ...
  const socialLinks = [
    { name: 'Facebook', icon: '📘', url: 'https://www.facebook.com/share/1AiBDVMkAs/?mibextid=wwXIfr' },
    { name: 'LinkedIn', icon: '🔗', url: 'https://www.linkedin.com/in/a-r-mubassira-27b1b7334?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app' },
    { name: 'Email', icon: '💬', url: 'rukshanamubass2000@gmail.com' },
  ];
  ...
  Dedicated to uplifting communities by promoting healthy lifestyles, mental well-being, and sustainable development through education, advocacy, and compassionate action.
</p>
