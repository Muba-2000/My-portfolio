...
function Hero() {
  ...
  const socialLinks = [
    { name: 'Email', icon: '✉️', link: 'mailto:rukshanamubass2000@gmail.com' },
    { name: 'LinkedIn', icon: '🔗', link: 'https://www.linkedin.com/in/a-r-mubassira-27b1b7334?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app' },
    { name: 'WhatsApp', icon: '💬', link: 'https://wa.me/your-number' },
    { name: 'Facebook', icon: '📸', link: 'https://www.facebook.com/share/1AiBDVMkAs/?mibextid=wwXIfr' },
  ];
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-b from-gray-50 to-white overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute inset-0 bg-[url('/my-portfolio/hero.jpg')] bg-cover bg-center opacity-80" />
      </div>
  ...
  whileTap={{ scale: 0.95 }}
  className="inline-block px-6 py-3 bg-[#082032] text-white rounded-lg font-medium shadow-lg hover:bg-opacity-90 transition-all"
>
  Download CV
</motion.a>
